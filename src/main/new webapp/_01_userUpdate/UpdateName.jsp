		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 sm-text">
					<h1 style="color:#fff; text-shadow:1px 1px 8px #000;"><strong>Update Name</strong></h1>
				</div>
				<table class="table table-hover col-md-12 ">
					<tr>
						<td>
							<h4 style="font-size: 30px;" class="sm-text1">Name</h4>
						</td>
						<td>
							<h4 style="font-size: 30px;" class="sm-text1">
								${LoginOK.name}
							</h4>
						</td>
					</tr>
				</table>
				<form method="POST" action="<c:url value='/_01_updateNameController.do'/>"
					id="/_01_updateDetailController.do" style="font-size: 30px;">
					<div class="form-group">
						<label for="exampleInputEmail1" style="color:#fff; text-shadow:1px 1px 8px #000;">New name</label>&nbsp;&nbsp;
						<font style="color: red;" id="errname">${errName}</font> <input
							type="text" name="name"  id="name" value="${param.name}"
							class="form-control" placeholder="Insert your new name"
