...
<link href="https://fonts.googleapis.com/css?family=Pacifico"
	rel="stylesheet">
<link rel="Shortcut Icon" type="image/x-icon" href="/CGLOHAS/image/logo.jpg">
...
<section style="padding-bottom: 0px; margin-bottom: 20px;">
<nav id="mainNav"
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="page-scroll"><a
					href="<c:url value='/_09_community/index_community.jsp'/>">Activity</a></li>
				<!-- 				<li class="page-scroll"><a -->
