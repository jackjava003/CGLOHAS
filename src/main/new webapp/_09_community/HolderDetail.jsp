		...
		<div class="row">
			<div align="center" style="padding-bottom: 50px;">
				<c:if test="${param.message eq 'existed'}">
					<font
						style="font-size: 40px; text-shadow: 1px 1px 8px #000; color: #fff;"><strong>Activity already exist, Please directly modify</strong></font>
				</c:if>
			</div>
				...
				<div role="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist"
						...
						<li role="presentation"><a href="#settings"
							...
							role="tab" data-toggle="tab"><strong>Join activity</strong></a></li>
										...
										<c:choose>
											<c:when test="${empty PageMessageBean.pageJoiner}">
												...
												<div align="center"
													...
													<strong>Currently no user join this activity</strong>
												</div>
											</c:when>
											<c:otherwise>
