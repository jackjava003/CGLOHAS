				...
				<div class="content">
					<div class="col-md-12" style="text-align: center;">
						<h1
							...
							<strong>Modify my activity</strong>
						</h1>
					</div>
					<form method="post"
						...
						<div class="col-md-8" style="vertical-align: middle;">
							...
							<table class="table" style="text-align: left;">
								...
								<tr>
									<th nowrap="nowrap"
										style="border: none; font-size: 22px; text-shadow: 1px 1px 8px #000; color: #fff;">Activity Status</th>
									<td><strong
										style="font-size: 18px; text-shadow: 1px 1px 8px #000; color: #fff;">
						...
						<div class="col-md-12"
							...
							<p class="btn">
								...
								<button onclick="back()" class="btn btn-warning" style="font-size: 22px; margin-left:10px;" >Back to my activity</button>
							</p>
						</div>
					</form>
				</div>
