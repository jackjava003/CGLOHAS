	...
	<div style="margin-bottom: 200px; font-family: 微軟正黑體;">
		<div class="container">
			<div class="row login-from">
				...
				<div class="col-md-8">
					<div align="center">
						<form action="<c:url value='forgetPassword.do' />" method="POST">
								...
								<tr>
									<td
										...
										<div class="form-group"
											...
											<label style="font-size: 30px;">Account&nbsp;&nbsp;<font
												id="errorAc" size="5" color="#FF0000">${MsgMap.errorAcc}</font></label><br>
											<input type="text" name="Account" value="${param.Account}"
												class="form-control" placeholder="Insert your account"
									...
									<td
										...
										<div class="form-group"
											...
											<label style="font-size: 30px;">E-mail&nbsp;&nbsp;<font
												id="errorEm" size="5" color="#FF0000">${MsgMap.errorEm}</font></label><br>
									...
									<td
										...
										<div class="form-group"
											...
											<label style="font-size: 30px;">Mobile&nbsp;&nbsp;<font
												id="errorPh" size="5" color="#FF0000">${MsgMap.errorPh}</font></label><br>
											<input type="text" name="Phone" value="${param.Phone}"
												placeholder="Insert your mobile" class="form-control"
												style="font-size: 30px;">
										</div>
									</td>
								</tr>
									...
									<td
										...
										<div class="form-group "
											...
											<input type="submit" value="Submit" class="btn btn-warning login-button"
												...
												href="<c:url value='login.jsp' />"><button type="button"
												...
												href="<c:url value='forgetAccount.jsp' />"><button
													...
													style="font-size: 20px; width: 120px;">Forget Account</button></a>
										</div>
									</td>
								</tr>
				...
				<div class="col-md-4">
					<img
						...
						src="${pageContext.request.contextPath}/image/masbia.jpg"> <img
						style="height: 360px; width: 400px; margin-bottom: 30px; border-radius: 10px; box-shadow: 10px 10px 5px #888888;"
						src="${pageContext.request.contextPath}/image/slide_346709_3657121_free.jpg">
				</div>
			</div>
		</div>
	</div>
